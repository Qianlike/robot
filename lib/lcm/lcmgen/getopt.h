...
struct getopt_option {
    ...
    int was_specified;  // did the user actually specify this option (as opposed to a default
                        // value)?
};
...
void getopt_add_int(getopt_t *gopt, char sopt, const char *lname, const char *def,
                    const char *help);
