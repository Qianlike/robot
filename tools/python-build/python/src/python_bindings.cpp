...
PYBIND11_MODULE(_core, m)
{
    ...
    py::class_<CanPort>(m, "CanPort", "单个通信板的 FDCAN 端口（构造需要硬件串口）")
        ...
        .def("stop", static_cast<void (CanPort::*)()>(&CanPort::stop))
        .def("stop", static_cast<void (CanPort::*)(uint8_t)>(&CanPort::stop), py::arg("id"))
        .def("brake", static_cast<void (CanPort::*)()>(&CanPort::brake))
        .def("brake", static_cast<void (CanPort::*)(uint8_t)>(&CanPort::brake), py::arg("id"))
        .def("reset", static_cast<void (CanPort::*)()>(&CanPort::reset))
        .def("reset", static_cast<void (CanPort::*)(uint8_t)>(&CanPort::reset), py::arg("id"))
    ...
    py::class_<Robot>(m, "Robot", "机器人控制接口（构造需要硬件串口，config_path 必传）")
        ...
        .def("stop", static_cast<void (Robot::*)()>(&Robot::stop))
        .def("stop", static_cast<void (Robot::*)(uint8_t, uint8_t)>(&Robot::stop), py::arg("can_port_id"), py::arg("id"))
        .def("brake", static_cast<void (Robot::*)()>(&Robot::brake))
        .def("brake", static_cast<void (Robot::*)(uint8_t, uint8_t)>(&Robot::brake), py::arg("can_port_id"), py::arg("id"))
        .def("reset", static_cast<void (Robot::*)()>(&Robot::reset))
        .def("reset", static_cast<void (Robot::*)(uint8_t, uint8_t)>(&Robot::reset), py::arg("can_port_id"), py::arg("id"))
